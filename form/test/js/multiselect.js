...
class ADMultiselect extends HTMLElement {
    ...
    updateHeader() {
        ...
        this.setAttribute('values', this.selList.join(';'));
    }
    setHeaderText(value) {
